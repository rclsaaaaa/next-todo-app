        ...
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-slate-50">
            ...
            <div className="glass-panel w-full max-w-md p-8 rounded-2xl">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 rounded-xl px-6 py-3.5 text-slate-700 font-medium hover:bg-slate-50 hover:border-slate-300 hover:shadow-md transition-all duration-200 shadow-sm"
                >
